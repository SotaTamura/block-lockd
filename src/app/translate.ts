...
const TRANSLATOR_MAP_ENTRIES = [
    ...
    ["利用規約", { us: "Terms of Service", gb: "Terms of Service", cn: "服务条款", tw: "使用條款" }],
    ["ニックネームを入力してください", { us: "Enter your nickname", gb: "Enter your nickname", cn: "输入昵称", tw: "輸入暱稱" }],
    [
        "ステージを作成するには、「設定」からニックネームを入力してください。",
        { us: 'To create stages, please enter your nickname in "Settings".', gb: 'To create stages, please enter your nickname in "Settings".', cn: '要创建关卡，请在"设置"中输入昵称。', tw: '要建立關卡，請在"設定"中輸入暱稱。' },
    ],
    ...
    ["速度", { us: "Speed", gb: "Speed", cn: "速度", tw: "速度" }],
    ...
    ["2つの黄色の鍵を取るタイミングが大事", { us: "Think carefully about when to pick up those 2 yellow keys.", gb: "Think carefully about when to pick up those 2 yellow keys.", cn: "取得两把黄色钥匙的时机很重要。", tw: "取得兩把黃色鑰匙的時機很重要。" }],
    ["自分で考えよう", { us: "Figure it out yourself.", gb: "Figure it out yourself.", cn: "自己想想吧。", tw: "自己想想吧。" }],
    [
        "ポータル\n\n同じアルファベットが書かれたポータル同士を行き来できる",
        { us: "Portal\n\nCan travel between portals with the same letter.", gb: "Portal\n\nCan travel between portals with the same letter.", cn: "传送门\n\n相同字母的传送门可以互通。", tw: "傳送門\n\n相同字母的傳送門可以互通。" },
    ],
    [
        "レバー\n\nその色のブロックの状態を何度でも切り替えることができる",
        { us: "Lever\n\nCan toggle blocks of that color any number of times.", gb: "Lever\n\nCan toggle blocks of that colour any number of times.", cn: "拉杆\n\n可无限次切换对应颜色方块的状态。", tw: "拉桿\n\n可無限次切換對應顏色方塊的狀態。" },
    ],
    ["一度に両方のプレイヤーが動く", { us: "Both players move at the same time.", gb: "Both players move at the same time.", cn: "两个玩家同时行动。", tw: "兩名玩家同時行動。" }],
    [
        "押しブロック\n\n左右に押せる\nジャンプで上に押し上げることもできる\n複数まとめて押せる\nポータルでテレポートする",
        {
            us: "Push Block\n\nPush left or right.\nJump to push upward.\nCan push multiple blocks at once.\nCan teleport through portals.",
            gb: "Push Block\n\nPush left or right.\nJump to push upward.\nCan push multiple blocks at once.\nCan teleport through portals.",
            cn: "推动方块\n\n可左右推动。\n跳跃可向上顶。\n可同时推动多个。\n可通过传送门传送。",
            tw: "推動方塊\n\n可左右推動。\n跳躍可向上頂。\n可同時推動多個。\n可透過傳送門傳送。",
        },
    ...
    ["ブロックをポータル間に跨らせた状態で静止させてみよう", { us: "Try pushing the block halfway through the portal.", gb: "Try pushing the block halfway through the portal.", cn: "试着让方块停在传送门之间。", tw: "試著讓方塊停在傳送門之間。" }],
    ["上陸", { us: "Landing", gb: "Landing", cn: "登陆", tw: "登陸" }],
    ["廊下", { us: "Corridor", gb: "Corridor", cn: "走廊", tw: "走廊" }],
    ["架け橋", { us: "Bridge", gb: "Bridge", cn: "桥梁", tw: "橋樑" }],
    ["雲", { us: "Cloud", gb: "Cloud", cn: "云", tw: "雲" }],
    ["路地", { us: "Alley", gb: "Alley", cn: "小巷", tw: "小巷" }],
    ["渦", { us: "Vortex", gb: "Vortex", cn: "漩涡", tw: "漩渦" }],
    ["細胞", { us: "Cell", gb: "Cell", cn: "细胞", tw: "細胞" }],
    ["虹", { us: "Rainbow", gb: "Rainbow", cn: "彩虹", tw: "彩虹" }],
    ["歪み", { us: "Distortion", gb: "Distortion", cn: "扭曲", tw: "扭曲" }],
    ["研究所", { us: "Laboratory", gb: "Laboratory", cn: "研究所", tw: "研究所" }],
    ["ダンジョン", { us: "Dungeon", gb: "Dungeon", cn: "地牢", tw: "地牢" }],
    ["坑道", { us: "Mine", gb: "Mine", cn: "矿道", tw: "礦道" }],
    ["双子", { us: "Twins", gb: "Twins", cn: "双子", tw: "雙子" }],
    ["異世界", { us: "Another World", gb: "Another World", cn: "异世界", tw: "異世界" }],
    ["運搬", { us: "Transport", gb: "Transport", cn: "运输", tw: "運輸" }],
    ["建築", { us: "Construction", gb: "Construction", cn: "建筑", tw: "建築" }],
    ["地下水道", { us: "Sewer", gb: "Sewer", cn: "地下水道", tw: "地下水道" }],
    ["屋根裏", { us: "Attic", gb: "Attic", cn: "阁楼", tw: "閣樓" }],
    ["マラソン", { us: "Marathon", gb: "Marathon", cn: "马拉松", tw: "馬拉松" }],
    ...
    ["おまじない", { us: "Magic Spell", gb: "Magic Spell", cn: "咒语", tw: "咒語" }],
] as const;
